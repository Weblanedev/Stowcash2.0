    ...
    <Providers>
      <Container site={site} page={page}>
        <main className="">
          ...
          <Marquee className={`bg-purple-20 py-[20px] text-purple-10 font-[600] mt-[800px] border-b-black border-b-[1px]`} autoFill>
            <div className="flex gap-[100px] ">
              <div className='relative w-[120px] xl:w-[150px] h-[120px] xl:h-[150px] '>
